...
/*
let a=5,b=6, c=-5;                         
console.log(a^b);//3  //2**2+2**0=4+1=5 means in the form of bits -> 1 0 1
console.log(a&b);//4
console.log(a|b);//7
...
11001 = 2**4+2**3+2**2+2**1+2**0=16+8+0+0+1=25
00010 = 2**4+2**3+2**2+2**1+2**0=0+0+0+2+0=2
-----------------------------------------------
11011 = 2**4+2**3+2**2+2**1+2**0=16+8+0+2+1=27
-----------------------------------------------
*/
...
console.log(2+5+'10');//710   // before string if there is no. then it consider as number
console.log('10'+2+'10');//10210
console.log('10'+2+6+8+9+'10');//10268910 // after the string it consider all number as a string 
...
//type coercion it converts string into a number while doing arithmetic  operation  except addition(+).
/*
console.log('10'-'15');//-5
console.log('5'*'5');//25
console.log('12'-'10');//2
...
console.log('10'+'15'+'2'+ 3); // 101523
console.log(10 + 2+ 15); //27
let a='15';
let b= Number(a);
console.log(b); // 15
console.log(typeof(b)) // number
...
console.log(royalfield['model1']['cost2']['cost']);
console.log(royalfield['model1']['cost2']['modelno']);
console.log(royalfield['model2']['cost2']['cost']);
console.log(royalfield['model2']['cost2']['modelno']);
...
console.log(text.substr(10,5))//,vish
...
console.log(text.replace(/name/i,"place")); //case sensitive
console.log(text.replaceAll("name","state")); //replace globally without g
console.log(text.replaceAll(/name/ig,"State")); //replace case sensitive and globally
*/
...
//console.log(e.padStart(50,text)); //it will add sentence at start and repeate that added sentence until length is complete 
// console.log(e.padEnd(120,text));  //it will add sentence at the end and repeate that added sentence until length is complete.
...
/*
let d=a.search(/name/gi); //give position of name it starts from 10 so print 10.
console.log(d);


let f= a.match(/name/ig); // it will print all matched value of name it return array of matched values
console.log(f);

let h="My Name is sai and my brother name is sai";  
let g= h.matchAll("sai"); //it returns iterator of all matched values.
console.log(g);

let i=h.includes("nam"); //true it returns boolean value
console.log(i);
let j=h.startsWith("hi") //false it returns boolean value
console.log(j);
let k=h.endsWith("sai"); //true  it returns boolean value
console.log(k);
*/
...
/*
let a=["durga","lakshman","babu","varsha"];
let b=a.sort();
console.log(b);

let c=[100,200,2,"tarun","Anju","subbu",25,500,5,"boost"];
let d=c.sort();
console.log(d);
...
console.log(person1.fname,person1.lname,person1.age,person1.fullname1);
*/
/*
...
let person ={
    ...
    language :" ",
    language1:" ",
    fun: function(langu,langu2){
        this.language=langu;
        this.language1=langu2;
    },
    get fname1(){
...
Students.student1 = s1; // dot notation
Students["student2"] = s2; // bracket notation
...
*/
/*
const fruits = new Map([["Apple",500],["oragne",200]]);
console.log(fruits);
...
console.log(person.fullName.call(person2,"from Rajahmundry","i am a Teacher"));
*/
...
console.log(person.fullName.apply(person2,["am","teacher"]));
*/
...
let nodeName = x.childNodes[5].nodeType;
...
elem3.id="p4";
elem3.innerHTML="i am from Dom as h1";
...
let div4=document.querySelector('div#div0');
